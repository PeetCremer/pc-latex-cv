...
\skilllist{AI/ML Specialization}{\tag{PyTorch (2+ yrs)} \tag{TensorFlow (2+ yrs)} \tag{LangChain/RAG} \tag{Vector Databases} \tag{Enterprise AI Strategy} \tag{Model Evaluation}}
