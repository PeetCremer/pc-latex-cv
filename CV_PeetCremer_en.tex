...
\skilllist{AI/ML Specialization}{\tag{Statistical Physics Theory} \tag{PyTorch (2+ yrs)} \tag{TensorFlow (2+ yrs)} \tag{LangChain/RAG} \tag{Vector Databases} \tag{Enterprise AI Strategy} \tag{Model Evaluation} \tag{AI Productivity Tooling} \tag{Model Context Protocol (MCP)}}
...
\skilllist{Engineering Leadership}{\tag{Technical Team Leadership} \tag{Strategic Hiring \& Talent Acquisition} \tag{AI Strategy Implementation} \tag{Cross-functional Collaboration} \tag{System Architecture} \tag{Production ML Systems}}
...
\job{Lecturer on Artificial Intelligence}
    ...
    {10/2020 - 04/2021}
    {
        ...
        \begin{itemize}[leftmargin=2em]
            \item Delivered 3 comprehensive lectures with exercises: Numerical Optimization (SOTA ML optimizers like Adam \& Evolutionary Algorithms), Gradient Boosting, and Support Vector Machines
            \item Independently created lecture materials covering both theoretical foundations and practical implementation
        \end{itemize}
    }
%
...
\section[\faTrophy]{Recognition \& Patents}
    \achievement{10 patents in automotive AI applications, covering training of radar perception algorithms, data storage, and fleet management systems}
