...
\tagline{AI Technical Leader with deep expertise in machine learning theory and enterprise AI strategy. Combines strong analytical foundation with proven experience managing engineering teams (up to 15 developers) and architecting production AI systems.\\ Currently leading enterprise adoption of cutting-edge AI development tools across 100+ engineers while staying deeply hands-on in technical development.}
...
\achievement{Managed up to 15 developers across multiple teams while maintaining only 2 customer-impacting incidents over 1 year}
\achievement{Architected production ML systems for building industrial knowledge graphs within an enterprise-scale data platform}
...
\job{Director of Engineering}
	...
	{02/2023 - 02/2024}
    {
        ...
        \begin{itemize}[leftmargin=2em]
            \item \textbf{Team Stabilization}: Absorbed responsibility for multiple teams during management transitions, scaling from 1 to 3 teams (up to 18 developers) while maintaining delivery commitments and service reliability
