...
\job{Software Development Expert}
    ...
    {07/2017 - 12/2020}
    {
        \textbf{Data Platform Engineering}: Built comprehensive data infrastructure and ML pipeline foundation for automotive sensor data, enabling advanced AI research and development capabilities.
        \begin{itemize}[leftmargin=2em]
            \item \textbf{Data Collection \& Processing}: Designed and implemented comprehensive data collection pipelines for automotive sensor data, including sophisticated recording tools and data preprocessing workflows
...
\skilllist{AI/ML Specialization}{\tag{PyTorch (2+ yrs)} \tag{TensorFlow (2+ yrs)} \tag{LangChain} \tag{RAG} \tag{Vector Databases} \tag{Support Vector Machines} \tag{Gradient Boosting} \tag{Model Evaluation} \tag{Model Context Protocol (MCP)}}
...
\skilllist{Engineering Leadership}{\tag{Technical Team Leadership} \tag{Strategic Hiring \& Talent Acquisition} \tag{Enterprise AI Strategy \& Implementation} \tag{AI Productivity Tooling Adoption} \tag{Cross-functional Collaboration} \tag{Operational Excellence} \tag{Production ML Systems}}
