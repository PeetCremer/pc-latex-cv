...
\tagline{Experienced Principal Engineer and former Engineering Leader with deep expertise in AI, Machine Learning, and scalable software architecture. Currently leading technical initiatives in AI evaluation and organizational tooling adoption at Cognite. My background combines hands-on engineering excellence (Python, C++, Rust) with proven leadership experience managing teams of up to 18 developers. I bring strategic thinking, data-driven decision making, and a collaborative approach to solving complex technical challenges in industrial AI applications.}
...
\job{Principal Engineer -- Atlas AI}
    ...
    {02/2023 - 2/2024}
    {
        Leading technical initiatives in AI evaluation and organizational tool adoption within Cognite's Atlas AI division. Key focus areas include:
        \begin{itemize}[leftmargin=2em]
            \item \textbf{AI Evaluation Frameworks:} Architecting and implementing comprehensive evaluation systems to measure performance of Cognite's industrial AI agents and underlying natural language processing tools
            \item \textbf{LLM Benchmarking:} Led creation of benchmark reports comparing various state-of-the-art models (Anthropic, OpenAI, Google, DeepSeek, Mistral) for industrial applications, resulting in data-driven model selection decisions
            \item \textbf{Organizational AI Tooling:} Pioneer work in identifying and procuring productivity-enhancing AI tools (Cursor, Bolt, Claude Code, Gemini Code Assist, MCP servers) for engineering organization
            \item \textbf{Cross-functional Leadership:} Collaborated with Legal, Security, Procurement, and Architecture teams to ensure compliant and secure rollout of AI tools across the organization
            \item \textbf{Knowledge Transfer:} Conducted training sessions and gave presentations at Global Town Halls on AI tool adoption strategies
        \end{itemize}
    }
%    
\job{Senior Director of Engineering}
    ...
    {02/2024 - 2/2025}
    {
        Advanced engineering leadership role overseeing multiple teams and strategic initiatives across Cognite's engineering organization:
        \begin{itemize}[leftmargin=2em]
            \item \textbf{Team Leadership:} Managed engineering teams of 10-15 developers focusing on data integration, \href{https://www.cognite.com/en/contextualization}{data connectivity}, and \href{https://www.cognite.com/en/product/atlas}{AI applications}
            \item \textbf{Strategic Hiring:} Led hiring initiative for Cognite's India Center of Excellence, developing staffing plans, job descriptions, interview processes, and managing recruitment pipeline for 20+ engineering roles
            \item \textbf{Product Strategy:} Contributed to product strategy development for Contextualization services at Cognite, aligning technical capabilities with business objectives
            \item \textbf{Organizational Growth:} Provided senior engineering leadership to support Cognite's scaling engineering organization, including culture building and process improvements
            \item \textbf{Cross-functional Collaboration:} People management, product leadership, and technical architecture decisions across multiple product areas
        \end{itemize}
    }
%
\job{Director of Engineering}
	...
	{02/2023 - today}
    {
        Engineering leadership role with significant team growth and dynamic organizational management:
        \begin{itemize}[leftmargin=2em]
            \item \textbf{Rapid Team Scaling:} Started with 1 team of 5 developers and grew to manage up to 18 developers across 3 teams within the timeframe, demonstrating rapid organizational scaling capabilities
            \item \textbf{Technical Focus Areas:} Led teams specializing in \href{https://www.cognite.com/en/contextualization}{contextualization of industrial data}, \href{https://www.cognite.com/en/industrial-canvas}{data-driven troubleshooting applications}, and \href{https://docs.cognite.com/cdf/integration/guides/contextualization/interactive_diagrams/}{parsing of engineering diagrams for industrial sites}
            \item \textbf{Adaptive Management:} Managed fluctuating team structures with 1 stable core team and 2 dynamic teams, flexibly filling organizational gaps as needed
            \item \textbf{Delivery Excellence:} Maintained high-performing teams while navigating rapid growth and changing organizational needs
        \end{itemize}
    }
%
...
%
\job{Language Model Finetuning for Industrial Natural Language Querying}
	{COGNITE, Oslo, Norway}
	{02/2025 - 04/2025}
    {
        Collaborated on finetuning language models to enhance natural language querying capabilities on Cognite's industrial knowledge graph:
        \begin{itemize}[leftmargin=2em]
            \item Created curated datasets of NLQ problems with ground truth answers for training and evaluation
            \item Implemented model finetuning pipelines to improve performance on domain-specific industrial queries
            \item Work recognized by CEO in \href{https://www.linkedin.com/posts/girish-rishi-4392587_atlas-ai-is-all-about-enabling-our-customers-activity-7336752688279207936-f58Y?utm_source=share&utm_medium=member_desktop&rcm=ACoAADAmkPABVhPkjuk0vvCtiRSid_p7fC4zU_o}{LinkedIn post} highlighting customer impact
        \end{itemize}
    }
%
\job{Comprehensive LLM Benchmark for Industrial AI Applications}
	{COGNITE, Oslo, Norway}
	{02/2025 - 04/2025}
    {
        Led comprehensive benchmarking initiative to evaluate state-of-the-art language models for Cognite's Atlas AI platform:
        \begin{itemize}[leftmargin=2em]
            \item Designed and executed evaluation framework for Natural Language Querying (NLQ) and Document Question Answering (DQA) on industrial knowledge graphs
            \item Created hundreds of curated test cases and evaluation infrastructure for models from Anthropic, OpenAI, Google, DeepSeek, and Mistral
            \item Analyzed performance of both instruction-tuned and reasoning models in agentic industrial applications
            \item Delivered external \href{https://www.cognite.com/en/resources/white-papers/atlas-ai-slm-llm-benchmark-report}{benchmark report} informing strategic model selection decisions
        \end{itemize}
    }
%
\job{Enterprise AI Tooling Strategy and Implementation}
	{COGNITE, Oslo, Norway}
	{03/2025 - 06/2025}
    {
        Led holistic initiative to identify, evaluate, and deploy productivity-enhancing AI tools across Cognite's engineering organization:
        \begin{itemize}[leftmargin=2em]
            \item \textbf{Technology Evaluation:} Assessed cutting-edge AI development tools including Cursor, Windsurf, Bolt, Claude Code, Gemini Code Assist, and Model Context Protocol (MCP) servers
            \item \textbf{End-to-End Procurement:} Led purchasing process from evaluation through deployment, working with Legal, Security, Procurement, and Architecture teams
            \item \textbf{Compliance and Security:} Ensured regulatory compliance and implemented security guardrails for enterprise AI tool adoption
            \item \textbf{Change Management:} Conducted training sessions and information sessions to drive effective and secure tool adoption
            \item \textbf{Executive Communication:} Presented findings at Global Town Hall, receiving recognition from CEO in \href{https://www.linkedin.com/posts/girish-rishi-4392587_peet-cremer-our-engineering-leader-showing-activity-7343289548442955776-Zu2p?utm_source=share&utm_medium=member_desktop&rcm=ACoAADAmkPABVhPkjuk0vvCtiRSid_p7fC4zU_o}{LinkedIn post}
        \end{itemize}
    }
%
\job{Strategic Hiring Initiative for India Center of Excellence}
	...
	{06/2024 - 12/2024}
    {
        Led strategic hiring initiative for Cognite's new engineering center in Bengaluru, India:
        \begin{itemize}[leftmargin=2em]
            \item \textbf{Strategic Planning:} Served on strategic committee to define staffing plan and organizational structure for new engineering center
            \item \textbf{Recruitment Infrastructure:} Designed comprehensive hiring framework including job descriptions, interview processes, take-home assignments, and evaluation criteria
            \item \textbf{Hiring Leadership:} Managed end-to-end recruitment process for 20+ engineering roles, coordinating multiple hiring pipelines and tracking progress against goals
            \item \textbf{Cross-functional Coordination:} Distributed hiring responsibilities across management team and facilitated regular synchronization meetings
            \item \textbf{Organizational Impact:} Contributed to successful launch of India Center of Excellence, as announced in \href{https://www.cognite.com/en/company/newsroom/cognite-inaugurates-india-center-of-excellence-in-bengaluru-with-commitment-to-leveraging-ai-for-industrial-growth}{press release}
        \end{itemize}
    }
%
