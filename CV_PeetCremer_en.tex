...
\tagline{I am a Machine Learning Engineer with an academic background in Computational Physics and Material Science. 
I combine strong analytical skills with advanced programming experience (Python, C++, Rust) and knowledge of Data Science frameworks. 
I have an outgoing, communicative personality, a hands-on attitude, possess lots of curiosity, and I am experienced in agile leadership of small teams.}
...
\job{Senior Machine Learning Engineer and Tech Lead}
    ...
    {\begin{itemize}[leftmargin=2em]
        ...
        \item Digitizing heavy industry by finding context in otherwise unstructured industrial data through intelligent algorithms
...
\altpublication{\textbf{P. Cremer}, H. Löwen, A. M. Menzel, \href{https://aip.scitation.org/doi/abs/10.1063/1.4934698}{"Tailoring superelasticity of soft magnetic materials"}, Appl. Phys. Lett. 107, 171903 (2015)
    \begin{itemize}
        \item FEM simulations to measure the stress-strain behavior of a magnetic elastomer (rubber with embedded magnetic particles)
        \item Discovered a "superelastic" stress-strain behavior, a phenomenon otherwise known from shape-memory alloys
    \end{itemize}
}
%
\altpublication{\textbf{P. Cremer} et al., \href{https://iopscience.iop.org/article/10.1088/1361-648X/aa73bd}{"A density functional approach to ferrogels"}, J. Phys.: Condens. Matter 29, 275102 (2017)
    \begin{itemize}
        \item Using a density functional theory formulation to describe how an ensemble of metallic particles behaves in an elastic matrix  
        \item Comparing the solution of this formalism with the results of particle Monte Carlo simulations
    \end{itemize}
}
%
\altpublication{T. Gundermann, \textbf{P. Cremer}, H Löwen, A. M. Menzel, S. Odenbach, \newline \href{https://iopscience.iop.org/article/10.1088/1361-665X/aa5f96}{"Statistical analysis of magnetically soft particles in magnetorheological elastomers"}, Smart Mater. Struct. 26, 045012 (2017)
    \begin{itemize}
        \item Statistical analysis of the particle distributions measured with x-ray micro tomography in samples of iron powder embedded into an elastic silicone matrix.
        \item Gaining insights about the microstructure and possible consequences on the magneto-mechanical properties of the material 
    \end{itemize}
}
%
\altpublication{\textbf{P. Cremer}, M. Marechal, H. Löwen, \href{https://iopscience.iop.org/article/10.1209/0295-5075/99/38005/meta}{"Director field in plastic crystals"}, Europhys. Lett. 99, 38005 (2012)
    \begin{itemize}
        \item This was my Bachelor Thesis. I performed particle Monte Carlo simulations of a system of anisotropic particles. 
        \item Analyzed the formation of topological defects within the Wigner-Seitz and explained it with a simplified model.
    \end{itemize}
}


\section[\faGears]{Selected IT and Data Science projects}
