...
\tagline{Enthusiastic Machine Learning Engineer with a background in Statistical Physics, currently in the role of an Engineering Manager. 
I combine advanced software engineering skills (Python, C++, Rust) with knowledge of machine learning frameworks (\mbox{TensorFlow}, PyTorch, scikit-learn) and experience in building scalable data platforms. 

I have an outgoing, communicative personality, a can-on attitude, and I have experience in leading teams of up to 20 people.}
...
\job{Director of Engineering}
    ...
    {\begin{itemize}[leftmargin=2em]
        \item Engineering manager of 18 developers in 3 teams, focusing on 
            \begin{itemize} 
