...
\achievement{7 peer-reviewed publications in Statistical Physics with direct applications to modern ML optimization}
...
\job{Principal Engineer -- Atlas AI}
    ...
    {02/2025 - today}
    {
        ...
        \begin{itemize}[leftmargin=2em]
            ...
            \item \textbf{LLM Technical Leadership}: Led benchmarking of state-of-the-art models (Anthropic, OpenAI, Google, DeepSeek) for industrial knowledge graph applications, directly informing Atlas AI architecture decisions
...
\job{Senior Director of Engineering}
    ...
    {02/2024 - 2/2025}
    {
        ...
        \begin{itemize}[leftmargin=2em]
            \item \textbf{Strategic Expansion}: Designed and executed hiring strategy for Cognite's India Center of Excellence, establishing staffing plans and engineering operations for 20+ roles (all successfully filled)
...
\job{Director of Engineering}
	...
	{02/2023 - 02/2024}
    {
        ...
        \begin{itemize}[leftmargin=2em]
            ...
            \item \textbf{Technical Focus}: Led teams specializing in contextualization of industrial data, data-driven troubleshooting applications, and parsing of engineering diagrams
        \end{itemize}
    }
%
...
\job{AI Lead Developer}
    ...
    {12/2020 - 07/2021}
    {
        ...
        \begin{itemize}[leftmargin=2em]
            ...
            \item Contributed to significant innovation pipeline, resulting in 7 patents and 1 publication focused on novel radar perception algorithms
        \end{itemize}
    }
%
...
\job{Ph.D., Theoretical Soft Matter Physics}
    ...
    {2013 - 2017}
    {
        \textbf{Strategic Foundation for AI Leadership}: Deep theoretical understanding of statistical systems, numerical optimization, and mathematical modeling that directly applies to modern ML challenges.
        \begin{itemize}[leftmargin=2em]
            ...
            \item 7 peer-reviewed publications demonstrating research depth and scientific communication skills
            \item Expertise in numerical simulations and optimization algorithms foundational to current ML work
        \end{itemize}
    }
%
...
\skilllist{Data Science Foundation}{\tag{NumPy/SciPy (Expert)} \tag{Scikit-learn (2+ yrs)} \tag{Statistical Analysis} \tag{Numerical Simulations} \tag{Mathematical Modeling}}
