...
\skilllist{AI/ML Specialization}{\tag{Statistical Physics Theory} \tag{PyTorch (2+ yrs)} \tag{TensorFlow (2+ yrs)} \tag{LangChain/RAG} \tag{Vector Databases} \tag{Support Vector Machines} \tag{Gradient Boosting} \tag{Enterprise AI Strategy} \tag{Model Evaluation} \tag{AI Productivity Tooling} \tag{Model Context Protocol (MCP)}}
