...
\job{Software Development Expert}
    ...
    {07/2017 - 12/2020}
    {
        ...
        \begin{itemize}[leftmargin=2em]
            \item \textbf{Data Platform Engineering}: Built end-to-end data platform for automotive sensor data, including collection pipelines, storage infrastructure, labeling systems, and preprocessing workflows
